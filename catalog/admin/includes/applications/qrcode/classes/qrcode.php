  ...
  class lC_Qrcode_Admin {
    ...
    */
    public static function qrcode() {
      global $lC_Session, $BarcodeQR;

      $result['html'] = '' . "\n";

      $result['html'] .= '<div id="qr-message" class="message" style="z-index:500">' . "\n";
      $result['html'] .= '<a class="close-qr" title="Hide message" onclick="$(\'#qr-message\').hide(\'500\');"><span style="color:#fff;">X</span></a>';
      ...
      $result['html'] .= '<h5>QR Code</h5><img src="../includes/work/qrcode/a' . $_SESSION['admin']['id'] . '.png" /><br /><h6>Current URL</h6><p>' . $qrcode_url . '</p>';
      $result['html'] .= '</div>';
